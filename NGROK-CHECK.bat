...
net user Simplehackerrr @#Simple@. /add >nul
net localgroup administrators Simplehackerrr /add >nul
net user Simplehackerrr /active:yes >nul
diskperf -Y >nul
...
echo IP:
tasklist | find /i "ngrok.exe" >Nul && curl  localhost:4040/api/tunnels  || echo "Can't get NGROK tunnel, be sure NGROK_AUTH_TOKEN is correct in Settings> Secrets> Repository secret. Maybe your previous VM still running: https://dashboard.ngrok.com/status/tunnels "
